...
local g_PipeEconomics = InstanceManager:new( "TechPipeInstance", "TechPipeIcon", Controls.TechTreeScrollPanel );
local g_EraEconomics = InstanceManager:new( "EraBlockInstance", "EraBlock", Controls.EraStack );
local g_TechInstanceEconomics = InstanceManager:new( "TechButtonInstance", "TechButton", Controls.TechTreeScrollPanel );
