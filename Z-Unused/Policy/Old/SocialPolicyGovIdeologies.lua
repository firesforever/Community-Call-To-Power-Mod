...
-------------------------------------------------
-- SocialPolicy Goverment Ideologies Page V1
-------------------------------------------------
...
function OnPopupMessage(popupInfo)
	...
	if (popupInfo.Data1 ~= 902) then
		return;
	end
	m_PopupInfo = popupInfo;

	PCat = "POLICYTREECAT_GOVERNMENTIDEOLOGIES";
	UpdateDisplay();
...
--	if numUnlockedBranches > 0 then
		...
		if policyBranchInfo ~= nil then
			...
			elseif (player:IsPolicyBranchBlocked(id)) then
				thisButton:SetHide( false );
				thisBack:SetColor( fadeColor );
				thisLock:SetHide( false );
	...
	if policyInfo ~= nil then
		...
		if (iBranch ~= nil) then
			if policyInfo.PolicyBranchType == "POLICY_BRANCH_CAPITALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_SOCIALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_LIBERALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_CONSERVATISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ENVIRONMENTALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_NATIONALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_POPULISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_PACIFISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_IMPERIALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ANARCHISM" then
...
function GetPipe(branchType)
	...
	if branchType == "POLICY_BRANCH_IMPERIALISM" then
...
function addpipes()
	...
	for row in GameInfo.Policy_PrereqPolicies() do
		...
		if (prereq ~= nil) then
		if prereq.PolicyBranchType == "POLICY_BRANCH_CAPITALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_SOCIALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_LIBERALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_CONSERVATISM" or prereq.PolicyBranchType == "POLICY_BRANCH_ENVIRONMENTALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_NATIONALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_POPULISM" or prereq.PolicyBranchType == "POLICY_BRANCH_PACIFISM" or prereq.PolicyBranchType == "POLICY_BRANCH_IMPERIALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_ANARCHISM" then
	...
	if policyInfo ~= nil then
		...
		-- If this is "GOAWAY" it means the Policy is a freebie handed out with the Branch, so don't display it
		if (iBranch ~= nil) then
			if policyInfo.PolicyBranchType == "POLICY_BRANCH_CAPITALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_SOCIALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_LIBERALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_CONSERVATISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ENVIRONMENTALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_NATIONALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_POPULISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_PACIFISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_IMPERIALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ANARCHISM" then
			local controlTable = nil;
			
			-- decide which panel it goes on
			if iBranch == "POLICY_BRANCH_IMPERIALISM" then
