...
-------------------------------------------------
-- SocialPolicy Government Systems Page V1
-------------------------------------------------
...
function OnPopupMessage(popupInfo)
	...
	if (popupInfo.Data1 ~= 903) then
		return;
	end
	m_PopupInfo = popupInfo;

	PCat = "POLICYTREECAT_GOVERNMENTSYSTEMS";
	UpdateDisplay();
...
--	if numUnlockedBranches > 0 then
	...
	if policyInfo ~= nil then
		...
		if (iBranch ~= nil) then
			if policyInfo.PolicyBranchType == "POLICY_BRANCH_FEDERALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_AUTOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ARISTOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_FEUDALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_PLURALISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_PARLIAMENTARY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_CONSTITUTIONAL" or policyInfo.PolicyBranchType == "POLICY_BRANCH_PLUTOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_TOTALITARIANISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ELECTORAL" then
...
function GetPipe(branchType)
	...
	if branchType == "POLICY_BRANCH_AUTOCRACY" then
...
function addpipes()
	...
	for row in GameInfo.Policy_PrereqPolicies() do
		...
		if (prereq ~= nil) then
		--**
		if prereq.PolicyBranchType == "POLICY_BRANCH_FEDERALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_AUTOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_ARISTOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_FEUDALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_PLURALISM" or prereq.PolicyBranchType == "POLICY_BRANCH_PARLIAMENTARY" or prereq.PolicyBranchType == "POLICY_BRANCH_CONSTITUTIONAL" or prereq.PolicyBranchType == "POLICY_BRANCH_PLUTOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_TOTALITARIANISM" or prereq.PolicyBranchType == "POLICY_BRANCH_ELECTORAL" then
	...
	if policyInfo ~= nil then
		...
		if (iBranch ~= nil) then
			...
			-- decide which panel it goes on
			if iBranch == "POLICY_BRANCH_AUTOCRACY" then
