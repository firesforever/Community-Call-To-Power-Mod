...
include("ResGeneratorFunctions.lua");
...
function OnMapResourceGenerator(New_ResourceType , ExecludesTable )
	...
	if New_Resource_Class == "RESOURCECLASS_LUXURY" then
		if resource_option == 1 then option_modifier = 0.04;
		elseif resource_option == 2 then option_modifier = 0.08;
		elseif resource_option == 3 then option_modifier = 0.16; 
		elseif resource_option == 4 then option_modifier = 0.32;
		elseif resource_option == 5 then option_modifier = 0.75;
		end
