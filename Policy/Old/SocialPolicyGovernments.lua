...
--	if numUnlockedBranches > 0 then
	...
	if policyInfo ~= nil then
		...
		if (iBranch ~= nil) then
			if policyInfo.PolicyBranchType == "POLICY_BRANCH_MONARCHY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_THEOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_REPUBLIC" or policyInfo.PolicyBranchType == "POLICY_BRANCH_DEMOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_FASCISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_COMMUNISM" or policyInfo.PolicyBranchType == "POLICY_BRANCH_CORPORATE" or policyInfo.PolicyBranchType == "POLICY_BRANCH_TECHNOCRACY" or policyInfo.PolicyBranchType == "POLICY_BRANCH_ECOTOPIA" or policyInfo.PolicyBranchType == "POLICY_BRANCH_VIRTUALDEMOCRACY" then
...
function addpipes()
	...
	for row in GameInfo.Policy_PrereqPolicies() do
		...
		if (prereq ~= nil) then
		if prereq.PolicyBranchType == "POLICY_BRANCH_MONARCHY" or prereq.PolicyBranchType == "POLICY_BRANCH_THEOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_REPUBLIC" or prereq.PolicyBranchType == "POLICY_BRANCH_DEMOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_FASCISM" or prereq.PolicyBranchType == "POLICY_BRANCH_COMMUNISM" or prereq.PolicyBranchType == "POLICY_BRANCH_CORPORATE" or prereq.PolicyBranchType == "POLICY_BRANCH_TECHNOCRACY" or prereq.PolicyBranchType == "POLICY_BRANCH_ECOTOPIA" or prereq.PolicyBranchType == "POLICY_BRANCH_VIRTUALDEMOCRACY" then
